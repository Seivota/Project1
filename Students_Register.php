<?php 
	include("Students_Register_Connection.php");
?>
<!DOCTYPE html>
<html>
<head>
	...
	<link rel="stylesheet" type="text/css" href="Students_Register.css">
</head>
<body>
	<div class="container">
		<div class="lfDiv"></div>
	...
	<form method="POST">
		...
		<label>Course: </label><input type="text" name="course" placeholder="Enter your course" required><br><br>
		<label>Home Address: </label><input type="text" name="address" placeholder="Enter your home address" required><br><br>
		<label>Phone NO: </label><input type="tel" pattern="[+]{1}[0-9]{3}-[0-9]{3}-[0-9]{3}-[0-9]{3}" name="phone1" placeholder="Enter your phone number +255-XXX-XXX-XXX"><br><br>
		<label>Phone NO: </label><input type="text" name="phone2" placeholder="Enter your parent/gurdian phone number" required><br><br>
		<label>Email: </label><input type="email" name="email" placeholder="Enter your email address" required><br><br>
		<?php echo $errormsg_3; ?>
		<label>Password: </label><input type="password" name="password" placeholder="Create password for your account" required><br><br>
